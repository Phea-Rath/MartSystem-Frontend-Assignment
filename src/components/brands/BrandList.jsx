            ...
            <div className=" p-6 mx-auto">
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between mb-6 gap-4">
                    <div>
                        ...
                        <p className="text-sm text-gray-500 dark:text-gray-400">Manage your product classifications ({brands?.total} total)</p>
                    </div>
                                    ...
                                    <tr key={brand.brand_id} className="hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                                        ...
                                        <td className="px-6 py-4">
                                            <div className="flex justify-end gap-2">
                                                <button onClick={() => handleEdit(brand)} className="p-2 text-blue-600 hover:bg-blue-50 rounded-md transition-colors" title="Edit">
                                                    <FaEdit size={16} />
                                                </button>
                                                <button onClick={() => handleDel(brand.brand_id)} className="p-2 text-red-600 hover:bg-red-50 rounded-md transition-colors" title="Delete">
                                                    <FaTrash size={16} />
                                                </button>
                                            </div>
                                        </td>
