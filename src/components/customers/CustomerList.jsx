        ...
        <div className="bg-transparent h-full relative">
            ...
            <div className="p-3 sm:p-6 mx-auto max-w-full">
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between mb-6 gap-3 sm:gap-4">
                    <div>
                        <h1 className="text-xl sm:text-2xl font-bold text-gray-800 dark:text-white">Customers</h1>
                        <p className="text-xs sm:text-sm text-gray-500 dark:text-gray-400">Manage your vendor relationships ({customers?.total || 0} total)</p>
                    </div>
                                        ...
                                        <tr key={item.customer_id} className="hover:bg-gray-50/50 dark:hover:bg-gray-700 transition-colors">
                                            ...
                                            <td className="px-6 py-4">
                                                <div className="flex justify-end gap-2">
                                                    ...
                                                    <button onClick={() => { setDelId(item.customer_id); setIsOpen(true); }} className="p-2 text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-gray-700 rounded-lg transition-colors border border-transparent hover:border-red-100 dark:hover:border-red-700 dark:hover:bg-gray-700">
                                                        <FaTrash size={16} />
                                                    </button>
                                                </div>
                                            </td>
                ...
                <div className="md:hidden space-y-3">
                    {!isPending && customers?.data?.map((item) => (
                        <div key={item.customer_id} className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-4">
                            <div className="flex items-start gap-3 mb-4">
                                <div className="p-2 bg-blue-50 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 rounded-lg">
                                    <FaTruck size={16} />
                                </div>
                                <div className="flex-1">
                                    <p className="font-semibold text-gray-800 dark:text-white">{item.customer_name}</p>
                                    <p className="text-xs text-gray-500 dark:text-gray-400">ID: #{item.customer_id}</p>
                                </div>
                            </div>
                            ...
                            <div className="flex gap-2">
                                ...
                                <button
                                    onClick={() => { setDelId(item.customer_id); setIsOpen(true); }}
